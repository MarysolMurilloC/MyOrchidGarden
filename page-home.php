<?php get_header(); ?>
  ...
  <div class="container-fluid ps-0 pe-0">
    ...
    <div class="bg-welcome">
      ...
      <div class="pos-tien">
        <p class="txt-tien pb-3">Quality orchids, supplements for them and more</p>
        <a type="button" class="btn btn-tien" href="tienda">Go shop</a>
      ...
      <div class="mar-tien">
          ...
          <div class="card col-adj">
            ...
            <div class="card-body">
            <a class="tit-pro" href="orquideas">Orchids</a>
            </div>
          </div>
          ...
          <img class="tam-img" src="<?php echo get_template_directory_uri()."/img/jcr_content.png"; ?>" alt="">
            <div class="card-body">
            <a class="tit-pro" href="suplementos">Supplements</a>
            </div>
          </div>
          ...
          <img class="tam-img" src="<?php echo get_template_directory_uri()."/img/maceta.jpg"; ?>" alt="">
            <div class="card-body">
            <a class="tit-pro" href="accesorios">Accesories</a>
            </div>
          </div>
          </div>
